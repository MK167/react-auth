...
export const ar: Locale = {
  ...
  errors: {
    orderNotFound: {
      ...
      description: 'الطلب الذي تبحث عنه غير موجود أو تمت إزالته. يرجى التحقق من قائمة طلباتك.',
    },
    productNotFound: {
      title: 'المنتج غير موجود',
      description: 'هذا المنتج لم يعد متاحاً. تصفح الكتالوج للعثور على ما يناسبك.',
    },
    unauthorized: {
      title: 'غير مصرح',
      description: 'يجب تسجيل الدخول للوصول إلى هذه الصفحة. يرجى تسجيل الدخول والمحاولة مجدداً.',
    },
    forbidden: {
      title: 'الوصول مرفوض',
    ...
    sessionExpired: {
      title: 'انتهت الجلسة',
      description: 'انتهت جلستك لأسباب أمنية. يرجى تسجيل الدخول مرة أخرى للمتابعة.',
    },
    serverError: {
      title: 'خطأ في الخادم',
      description: 'حدث خطأ من جانبنا. تم إبلاغ فريقنا وهو يعمل على إصلاحه. يرجى المحاولة مجدداً بعد قليل.',
    },
    networkError: {
      title: 'خطأ في الاتصال',
      description: 'تعذر الوصول إلى خوادمنا. يرجى التحقق من اتصالك بالإنترنت والمحاولة مجدداً.',
    },
    featureDisabled: {
      title: 'الميزة غير متاحة',
      description: 'هذه الميزة غير مفعّلة لحسابك حالياً. تواصل مع الدعم للمزيد من المعلومات.',
    },
    validationError: {
      title: 'خطأ في التحقق',
      description: 'بعض المعلومات التي أدخلتها غير صحيحة. يرجى مراجعة البيانات والمحاولة مجدداً.',
    },
    resourceNotFound: {
      title: 'غير موجود',
      description: 'المورد الذي تبحث عنه غير موجود أو ربما تم نقله.',
    },
    unknownError: {
      title: 'حدث خطأ ما',
      description: 'حدث خطأ غير متوقع. إذا استمر هذا، يرجى التواصل مع الدعم.',
    },
  },
